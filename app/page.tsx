        ...
        <div className="max-w-2xl px-6 pt-16 pb-12 space-y-12 flex-grow" style={{ marginLeft: 'clamp(10px, 12vw, 200px)' }}>
          ...
          <section className="space-y-2">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-neutral-800">
              I build systems and run studies that turn market signal into company strategy. At Figma, I lead the market intelligence function — where I build the company's understanding of the product development landscape to inform where and how we invest next.
            </p>
